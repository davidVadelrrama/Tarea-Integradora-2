...
public class ChannelBlackSnail{
	...
	public void addSeries(String seriesName, String seriesDirector, String seriesSinopsis, String seriesTrailer, int sDay, int sMonth, int sYear, int censored, String motive){
		...
		Series serie = new Series(seriesName, seriesDirector, seriesSinopsis, seriesTrailer, motive, launchDate,isCensored);
